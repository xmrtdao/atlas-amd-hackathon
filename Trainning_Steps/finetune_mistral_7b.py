#!/usr/bin/env python3
# ============================================================
# ATLAS Mistral-7B Legal FullFinetune
# AMD MI300X 205GB | adamw_torch | ROCm 7.0
# Dataset: 6437 examples (Ronda 1) → 3502 examples (Ronda 2)
# Memory: ~50GB GPU (model 14 + grad 14 + opt 22)
# ============================================================
...
CONFIG = {
    ...
    "output_dir": "/outputs/atlas_mistral_7b_finetuned",
...
def main():
    logger.info("=" * 60)
    logger.info("  ATLAS Mistral-7B Legal FullFinetune")
    logger.info("  AMD MI300X | adamw_torch | 6437/3502 examples | 3 epochs")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("  ATLAS MISTRAL-7B LEGAL DONE")
